...
//        }
        ...
        //2.16 Change the Qty to "2" and Click on "Update shopping cart"
        toClear(By.xpath("//input[@class = 'qty-input']"));
        ...
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Jhon");
        sendTextToElement(By.id("BillingNewAddress_Email"), "maryjohn@gmail50.com");
